...
class CustomAugmentation:
    def __init__(self, resize, mean, std, **args):
        centercrop = [CenterCrop((320, 256))]
        colorjitter = [ColorJitter(0.1, 0.1, 0.1, 0.1)]
        self.transform = Compose(
            [
                RandomApply(centercrop, p=0.5),
                Resize(resize, Image.BILINEAR),
...
# Multi label, split by profile
class MultiLabelSplitDataset(MaskBaseDataset):
    def __init__(
        self,
        data_dir,
        mean=(0.548, 0.504, 0.479),
