...
def train(data_dir, model_dir, args):
    ...
    for epoch in range(args.epochs):
        ...
        for idx, train_batch in enumerate(train_loader):
            ...
            preds = mask_preds * 6 + gender_preds * 3 + age_preds  # shape is [batch, 1]
            ...
            if (idx + 1) % args.log_interval == 0:
                ...
                logger.add_scalar("Train/f1", f1_train, epoch * len(train_loader) + idx)
        ...
        with torch.no_grad():
            ...
            if val_acc > best_val_acc:
                ...
                torch.save(model.module.state_dict(), f"{save_dir}/best.pth")  # 최선의 모델
                best_val_acc = val_acc
            torch.save(model.module.state_dict(), f"{save_dir}/last.pth")  # 최고 epoch 모델
            print(
    ...
    #     age_preds = age_outs.argmax(1)
    #     preds = mask_preds*6 + gender_preds*3 + age_preds
    #     # f1_test += f1_score(preds.cpu().numpy(), labels.cpu().numpy(), average="macro")
    #     index = (preds.detach().cpu()!=labels)
    #     wrong_images=[]
    ...
    #                 break
    #     inputs = inputs[wrong_images]
    #     labels=labels[wrong_images]
    #     preds = preds[wrong_images]
    ...
    #     )
    #     logger.add_figure("False images", figure, epoch)
    #     print("checked")
    #     break
